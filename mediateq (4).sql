...
--
-- Client :  localhost
-- Généré le :  Mer 18 Mai 2022 à 17:10
...
INSERT INTO `abonnee` (`id`, `password`, `email`) VALUES
(1, 'mdp', 'sio@gmail.com'),
(2, 'dev', 'alex@gmail.com'),
(3, 'dev2', 'yanisse@gmail.com'),
(4, 'chef', 'jc@gmail.com');
...
--
-- Contenu de la table `descripteur`
--
...
('00001', 'Quand sort la recluse', 'Images/Livres/quand-sort-la-recluse.jpg', NULL, '00002'),
('00002', 'Un pays à l\'aube', 'Images/Livres/un-pays-a-l-aube.jpg', NULL, '00002'),
('00003', 'Et je danse aussi', 'Images/Livres/et-je-danse-aussi.jpg', NULL, '00003'),
('00004', 'L\'armée furieuse', 'Images/Livres/l-armee-furieuse.jpg', NULL, '00002'),
('00005', 'Les anonymes', 'Images/Livres/les-anonymes.jpg', NULL, '00002'),
('00006', 'La marque jaune', 'Images/Livres/la-marque-jaune.jpg', NULL, '00003'),
('00007', 'Dans les coulisses du musée', 'Images/Livres/dans-les-coulisses-du-musee.jpg', NULL, '00003'),
('00008', 'Histoire du juif errant', 'Images/Livres/histoire-du-juif-errant.jpg', NULL, '00002'),
('00009', 'Pars vite et reviens tard', 'Images/Livres/pars-vite-et-reviens-tard.jpg', 0, '00002'),
('00010', 'Le vestibule des causes perdues', 'Images/Livres/le-vestibule-des-causes-perdues.jpg', 0, '00002'),
('00011', 'L\'ile des oublies', 'Images/Livres/l-ile-des-oublies.jpg', 0, '00002'),
('00012', 'La souris bleue', 'Images/Livres/la-souris-bleue.jpg', 0, '00002'),
('00013', 'Sacré Pêre Noël', 'Images/Livres/sacre-pere-noel.jpg', 0, '00002'),
('00014', 'Mauvaise étoile', 'Images/Livres/mauvaise-etoile.jpg', 0, '00002'),
('00015', 'La confrérie des téméraires', 'Images/Livres/la-confrerie-des-temeraires.jpg', 0, '00002'),
('00016', 'Le butin du requin', 'Images/Livres/le-butin-du-requin.jpg', 0, '00002'),
('00017', 'Catastrophes au Brésil', 'Images/Livres/catastrophes-au-bresil.jpg', 0, '00002'),
('00018', 'Le Routard - Maroc', 'Images/Livres/routard-maroc.jpg', 0, '00002'),
('00019', 'Guide Vert - Iles Canaries', 'Images/Livres/guide-vert-canaries.jpg', 0, '00002'),
('00020', 'Guide Vert - Irlande', 'Images/Livres/guide-vert-Irlande.jpg', 0, '00002'),
('00021', 'Les déferlantes', 'Images/Livres/les-deferlantes.jpg', 0, '00002'),
('00022', 'Une part de Ciel', 'Images/Livres/une-part-de-ciel.jpg', 0, '00002'),
('00023', 'Le secret du janissaire', 'Images/Livres/de-cape-et-de-crocs-1.jpg', 0, '00002'),
('00024', 'Pavillon noir', 'Images/Livres/de-cape-et-de-crocs-2.jpg', 0, '00002'),
('00025', 'L\'archipel du danger', 'Images/Livres/de-cape-et-de-crocs-3.jpg', 0, '00002');
...
('00004', '1', '2022-03-01', '1', '00002'),
('00023', '2', '2022-03-03', '3', '00001'),
('00023', '34', '2022-03-03', '1', '00002');
...
ALTER TABLE `document`
  ...
  ADD CONSTRAINT `document_ibfk_2` FOREIGN KEY (`id`) REFERENCES `livre` (`idDocument`);
